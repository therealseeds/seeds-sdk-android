...
public class InAppMessagingAdapter {
    ...
    private final static String MESSAGING_CLASS_NAME = "com.playseeds.android.sdk.inappmessaging.InAppMessageManager";
    ...
    public static boolean init(Context context, String serverURL, String appKey, String deviceID, DeviceId.Type idMode) {
        try {
            ...
            Log.e(TAG, "Couldn't init Seeds InAppMessaging", logged);
            return false;
        }
    }
}
